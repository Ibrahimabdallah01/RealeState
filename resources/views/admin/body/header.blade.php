            ...
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="#" id="profileDropdown" role="button"
                    ...
                    <img class="wd-30 ht-30 rounded-circle"
                        src="{{ asset('uploads/profile_pictures/' . auth()->user()->photo) }}" alt="profile">
                    @else
                ...
                <div class="dropdown-menu p-0" aria-labelledby="profileDropdown">
                    <div class="d-flex flex-column align-items-center border-bottom px-5 py-3">
                        <div class="mb-3">
                            @if(auth()->user()->photo)
                                <img class="wd-80 ht-80 rounded-circle" src="{{ asset('uploads/profile_pictures/' . auth()->user()->photo) }}" alt="profile">
                            @else
                                <img class="wd-80 ht-80 rounded-circle" src="https://via.placeholder.com/80x80" alt="profile">
                            @endif
                        </div>                        
